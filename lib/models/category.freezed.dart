...
abstract class $CategoryCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? name, int? parent});
}
...
class _$CategoryImpl extends _Category {
  const _$CategoryImpl({this.id, this.name, this.parent}) : super._();
...
abstract class _Category extends Category {
  const factory _Category(
      {final int? id, final String? name, final int? parent}) = _$CategoryImpl;
